...
4. DEADLINE & TIME RESOLUTION RULES (RUSSIAN SEMANTICS):
   ...
   - CRITICAL WEEKDAYS: Any weekday mention ("во вторник", "в среду", "в пятницу", "до вторника") is ALWAYS strictly in the future (from +1 to +7 days, NEVER today!).
     * If today is ALREADY that weekday (e.g. today is Tuesday, Aug 18), saying "во вторник" / "до вторника" ALWAYS means NEXT WEEK's Tuesday (+7 days -> Aug 25, 2026). (Because for today, users say "сегодня").
     * If today is Monday (Aug 17), "во вторник" means tomorrow (+1 day -> Tuesday, Aug 18).
     * If today is Wednesday (Aug 19), "во вторник" means next Tuesday (+6 days -> Tuesday, Aug 25).
   ...
   - If exact time is stated with "до" (e.g., "до 15:23 во вторник", "до 15:23 до вторника"), use that exact hour on that upcoming occurrence of that weekday (e.g., if today is Tuesday Aug 18 -> next Tuesday Aug 25 at 15:23:00).
   - "в [День недели]" (e.g., "во вторник", "в пятницу") without exact hour -> that upcoming day at 18:00:00.
